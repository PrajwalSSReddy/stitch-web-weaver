        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {skills.map((skill, index) => (
              ...
              >
                <div className="w-20 h-20 mx-auto mb-4 bg-slate-800 rounded-2xl flex items-center justify-center group-hover:bg-slate-700 transition-colors duration-300">
      ...
      <section className="py-20 px-6">
        <ParallaxSection offset={20}>
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-center bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-3xl p-12 mx-auto max-w-4xl"
          >
